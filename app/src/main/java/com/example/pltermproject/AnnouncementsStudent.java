...
public class AnnouncementsStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Intent intent = new Intent(AnnouncementsStudent.this, AnnouncementsInfo.class);
                                    ...
                                    if(task.isSuccessful()){
                                        ...
                                        if(!qSnap.isEmpty()){
                                            for (int j = 0; j < task.getResult().getDocuments().size(); j++){
                                                ...
                                                arrayAdapter = new ArrayAdapter(AnnouncementsStudent.this, android.R.layout.simple_list_item_1, arrayList);
    ...
    public boolean onSupportNavigateUp(){
        final Intent intent2 = new Intent(AnnouncementsStudent.this,Student.class);
        finish();
